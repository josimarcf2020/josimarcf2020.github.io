document.addEventListener('DOMContentLoaded', () => {
    ...
    txtHabilidades += '<ul><li><strong>Desenvolvimento de Aplicativos iOS</strong>: Proficiência em desenvolvimento para dispositivos iOS utilizando Swift, SwiftUI e Xcode.</li>';
    txtHabilidades += '<li><strong>Gestão de Interface (Front-end)</strong>: Criação de views alinhadas a especificações de design, conectando-as via ViewModels (VMC).</li>';
    txtHabilidades += '<li><strong>Desenvolvimento de APIs</strong>: Criação e integração de APIs.</li>';
    ...
    txtHabilidades += '<li><strong>Banco de Dados</strong>: Experiência com Core Data, MongoDB, Firebase e bancos relacionais como MySQL.</li>';
    ...
    txtHabilidades += '<li><strong>Integração de Sistemas</strong>';
    txtHabilidades += '</ul>';
    ...
    txtExperiencia += '<ul>';
    txtExperiencia += ' <li><strong>Residente - Projeto Restic 12 Instituto iRede</strong> <a href="./doc/Certificado JOSIMAR DA CUNHA FERREIRA - Residencia TIC 12.pdf" target="_blank">Certificado</a>';
    txtExperiencia += ' <ul>';
    txtExperiencia += '     <li>Desenvolvimento de aplicativos para dispositivos iOS utilizando Swift, framework SwiftUI, xCode.';
    txtExperiencia += '     <li>Colaboração com equipes multifuncionais utilizando GIT/GITHUB.';
    txtExperiencia += '     <li>Codificação de rotinas para conectar as views aos modelos através de ViewModels VMC.';
    txtExperiencia += '     <li>Desenvolvimento de API';
    ...
    txtExperiencia += '     </ul>';
    txtExperiencia += '  </ul>';
    txtExperiencia += '  <li><strong>Programador Júnior xHarbour - Cooperativa Mista dos Avicultores do Piauí</strong>';
    txtExperiencia += '  <ul>';
    ...
    txtExperiencia += '  </ul>';
    txtExperiencia += '  <li><strong>Programador Senior Clipper - AESPI Assoc de Ensino Superior do Piauí LTDA</strong>';
    txtExperiencia += '  <ul>';
    ...
    txtEducacao += ' <li><strong>Graduação: Análise e Desenvolvimento de Sistemas - Faculdade CDL</strong> Fortaleza-CE 3º Periodo</li>';
    txtEducacao += '</ul>';
